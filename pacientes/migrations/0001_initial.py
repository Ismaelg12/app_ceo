# Generated by Django 3.1.7 on 2021-04-21 23:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sus', models.CharField(blank=True, max_length=18, null=True, unique=True)),
                ...
                ('tratamento', models.CharField(blank=True, choices=[('IN', 'Iniciado'), ('CO', 'Concluido'), ('RE', 'Aguardando ligação')], default='RE', max_length=2, verbose_name='tratamento')),
